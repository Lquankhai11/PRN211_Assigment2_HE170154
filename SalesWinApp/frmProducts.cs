...
namespace SalesWinApp
{
    public partial class frmProducts : Form
    {
        ...
        private void frmProducts_Load(object sender, EventArgs e)
        {
            ...
            dgvProducts.CellDoubleClick += DvgProductList_CellDoubleClick;
        }
        ...
        {
            var searchProductIdText = txtSearch.Text;
            var serchKey = cbTypeSearch.Text;
            ...
            else
            {
                ...
                else if (serchKey.Equals("Name"))
                {
                    ...
                    else
                    {
                        ...
                        {
                            if (product.ProductName.ToLower().Contains(txtSearch.Text.Trim().ToLower()))
                            {
