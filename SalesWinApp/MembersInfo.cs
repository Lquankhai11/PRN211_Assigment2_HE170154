    ...
    public partial class frmMembersInfo : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    if (txtMemberID.Text.Trim().Length != 0 && txtEmail.Text.Trim().Length != 0 && txtPassword.Text.Trim().Length != 0 && txtCountry.Text.Trim().Length != 0&& txtPassword.Text.Trim().Length != 0
                        && txtCity.Text.Trim().Length != 0 && txtCompanyName.Text.Trim().Length != 0)
                    {
                    ...
                    {
                        MessageBox.Show("Must fill all the field.");
                    }
                }
                else
                {
                    if (txtEmail.Text.Trim().Length != 0 && txtPassword.Text.Trim().Length != 0 && txtCountry.Text.Trim().Length != 0 && txtPassword.Text.Trim().Length != 0
                        && txtCity.Text.Trim().Length != 0 && txtCompanyName.Text.Trim().Length != 0)
                    {
