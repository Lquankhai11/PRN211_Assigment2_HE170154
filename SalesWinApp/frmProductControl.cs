    ...
    public partial class frmProductControl : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    if (txtProductID.Text.Trim().Length != 0 && txtProductName.Text.Trim().Length != 0 && txtCategoryID.Text.Trim().Length != 0 && txtUnitPrice.Text.Trim().Length != 0 && txtUnitsInStock.Text.Trim().Length != 0)
                    {
                ...
                {
                    if (txtProductName.Text.Trim().Length != 0 && txtCategoryID.Text.Trim().Length != 0 && txtUnitPrice.Text.Trim().Length != 0 && txtUnitsInStock.Text.Trim().Length != 0)
                    {
        ...
        private void frmProductControl_Load(object sender, EventArgs e)
        {
